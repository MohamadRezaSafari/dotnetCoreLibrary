...
//{
//    public class PagedListExtendedCore<T> : BasePagedList<T>
//    {
//        private PagedListExtendedCore()
//        {
//        }

//        public static async Task<IPagedList<T>> Create(IQueryable<T> superset, int pageNumber, int pageSize)
//        {
//            var list = new PagedListExtendedCore<T>();
...
//        {
//            return await PagedListExtendedCore<T>.Create(superset, pageNumber, pageSize);
//        }
//    }
//}