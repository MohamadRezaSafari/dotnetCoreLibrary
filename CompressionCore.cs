...
namespace Providers
{
    public class CompressionCore
    {
        ...
        // string name = await CompressionCore.VariousQualityFromStream(file, _hostingEnvironment, "low", null, 3);
        ...
        /*
         *   CompressionCore.VariousQuality("e6418d2c-d816-4b85-ac54-f5b2a0a3bace.jpeg", "low");
         */
